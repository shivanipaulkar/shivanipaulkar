...
🛠️ Skills & Tools
CategoryToolsLanguagesSQL (SQL Server) • Python (Pandas, NumPy, Matplotlib, Seaborn)VisualizationPower BI (DAX, Power Query, Data Modeling) • Advanced ExcelAnalyticsEDA • Feature Engineering • Descriptive & Inferential StatisticsFinance DomainFinancial Auditing • ITR / GST / TDS Compliance • Tally ERP
